      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 md:px-8 py-6"
        ...
        <div className="w-full max-w-[420px] bg-white border border-[#c2c7cf] rounded-lg p-8 shadow-sm">
          ...
          <header className="flex flex-col items-center text-center mb-6">
            <div className="w-16 h-16 rounded-full bg-[#2E6B3E] flex items-center justify-center mb-3 shadow-md">
              <span className="material-symbols-outlined text-white text-3xl"
                    style={{ fontVariationSettings: "'FILL' 1" }}>lock_reset</span>
            </div>
            <h1 className="text-xl font-semibold text-[#2E6B3E] mb-1">Khôi phục mật khẩu</h1>

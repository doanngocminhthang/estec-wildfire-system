      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 md:px-8 py-6"
        ...
        <div ref={cardRef}
          ...
          <header className="flex flex-col items-center text-center mb-6">
            <div className="w-20 h-20 rounded-full bg-[#2E6B3E] flex items-center justify-center mb-4 shadow-md">
              <span className="material-symbols-outlined text-white text-5xl"
                    style={{ fontVariationSettings: "'FILL' 1" }}>forest</span>
            </div>
            <h1 className="text-2xl font-semibold text-[#2E6B3E] mb-1">Hệ thống Wildfire</h1>

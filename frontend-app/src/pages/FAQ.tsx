...
const QUICK_LINKS = [
  { label: 'Bản đồ',    to: '/map',         icon: 'map' },
  { label: 'Sự cố',     to: '/incidents',   icon: 'local_fire_department' },
  { label: 'Tìm kiếm',  to: '/search',      icon: 'manage_search' },
  { label: 'Thống kê',  to: '/analytics',   icon: 'bar_chart' },
  { label: 'Hồ sơ',     to: '/profile',     icon: 'account_circle' },
]
    ...
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <div className="bg-gradient-to-r from-[#1a2e4a] to-[#1565c0] px-6 py-10 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/70 text-sm mb-6">Hướng dẫn sử dụng hệ thống cảnh báo cháy rừng PCCCR Thanh Hóa</p>
          ...
          <div className="relative max-w-lg mx-auto">
            ...
            <input
              ...
              placeholder="Tìm câu hỏi... (vd: đo khoảng cách, đổi mật khẩu)"
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {!isSearching && (
          <div className="mb-8">
            <p className="text-xs font-semibold text-[#94a3b8] uppercase tracking-wider mb-3">Truy cập nhanh</p>
        ...
        <div className="flex gap-6">
          ...
          {!isSearching && (
            <div className="w-44 flex-shrink-0">
              <p className="text-xs font-semibold text-[#94a3b8] uppercase tracking-wider mb-3">Danh mục</p>
          ...
          <div className="flex-1 min-w-0">
            {isSearching && (
              <p className="text-sm text-[#64748b] mb-4">
                {filteredItems.length > 0
                  ? `Tìm thấy ${filteredItems.length} kết quả cho "${query}"`
            ...
            {filteredItems.length === 0 ? (
              <div className="text-center py-16 text-[#94a3b8]">
                ...
                <p className="text-xs mt-1">Thử từ khóa khác hoặc liên hệ admin</p>
              </div>
            ) : (
            ...
            {!isSearching && (
              <div className="mt-8 p-4 bg-[#eff6ff] border border-[#bfdbfe] rounded-xl flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#1e293b]">Không tìm thấy câu trả lời?</p>
                  <p className="text-xs text-[#64748b] mt-0.5">Liên hệ quản trị viên hệ thống hoặc đội kỹ thuật ESTEC để được hỗ trợ.</p>
                </div>
              </div>
            )}
          </div>

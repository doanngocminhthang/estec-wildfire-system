...
const SAMPLE_RANGERS: User[] = [
  { id: 2, username: 'ranger01', full_name: 'Trần Thị Bình',  email: 'binh.tran@kiemlamthanhhoa.vn',  role: 'ranger', is_active: true },
  { id: 3, username: 'ranger02', full_name: 'Lê Văn Cường',   email: 'cuong.le@kiemlamthanhhoa.vn',   role: 'ranger', is_active: true },
  { id: 5, username: 'ranger03', full_name: 'Hoàng Văn Em',   email: 'em.hoang@kiemlamthanhhoa.vn',   role: 'ranger', is_active: false },
]
...
export default function AOR() {
  ...
  useEffect(() => {
    api.get<User[]>('/users')
      .then(({ data }) => setRangers(data.filter((u) => u.role === 'ranger')))
      .catch(() => setRangers(SAMPLE_RANGERS))
